      ...
      <header className="border-b border-nova-blue/20 bg-nova-bg">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-full bg-nova-blue px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-white">
              Admin
            </span>
          </div>
              ...
              {jogosState.map((jogo) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-3 w-full rounded-lg bg-nova-blue py-2 text-sm text-white transition hover:bg-nova-blue"
                  >
                    📁 Trocar Imagem
                  </button>
                </div>
              ...
              {bannersState.map((banner) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="rounded-full bg-nova-card px-3 py-1 text-xs text-nova-blueBright">
                      {banner.tag}
                    </span>
                  </div>
                  ...
                  <input
                    ...
                    className="mb-2 w-full rounded-lg border border-nova-blue/30 bg-nova-card px-3 py-2 text-sm text-white"
                  />
                  ...
                  <button
                    ...
                    className="mt-3 rounded-lg bg-nova-blue px-4 py-2 text-sm text-white transition hover:bg-nova-blue"
                  >
                    📁 Imagem de Fundo
                  </button>
                </div>
